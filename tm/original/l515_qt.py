...
class l515(QThread):
    ...
    def __init__(self):
        ...
        self.depth_filter.set_option(rs.option.min_distance, 0)
    ...
    def recording(self):
        ...
        try:
            while self.flag:
                ...
                qtImg = QImage(rgbImg.data, w, h, bytesPerLine, QImage.Format_RGB888)
                qtImg = qtImg.scaled(864, 486, QtCore.Qt.KeepAspectRatio)
                self.colorViewer.setPixmap(QPixmap.fromImage(qtImg))
